...
require('lazy').setup({
  ...
  require 'kickstart.plugins.gitsigns', -- Git functionality
  require 'kickstart.plugins.which-key', -- Neovim keystroke info
  require 'kickstart.plugins.telescope', -- Searching tool
  require 'kickstart.plugins.conform', -- Formatting code.
  require 'kickstart.plugins.nvim-cmp', -- Autocomplete
  ...
  require 'custom.plugins.lualine', -- Status bar.
